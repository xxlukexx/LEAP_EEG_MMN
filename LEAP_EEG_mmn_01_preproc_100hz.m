...
%     lm_addCommonPaths
%     ft_defaults
    if isempty(gcp('nocreate')), parpoolnum(32), end
...
% preprocess
    ...
    parfor d = 1:numSubs
        ...
        ops{d}.MMN_FoundRawFile = exist(file_raw, 'file') == 2;
        if ~ops{d}.MMN_FoundRawFile, continue, end
        
        % temp serial function call
        [~, file_out, ops{d}] =...
            LEAP_EEG_mmn_01_doPreProc(ops{d}, file_raw, site, id,...
